...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_EVENTS_TABLE = "create table "+DBStructure.EVENT_TABLE_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT, "
            ...
            +DBStructure.YEAR+" TEXT, "+DBStructure.Progress+" TEXT, "+DBStructure.Notify+" TEXT)";
    ...
    public void SaveEvent(String event, String description, String time,String date,String month,String year,String progress,String notify,SQLiteDatabase database){
        ...
        contentValues.put(DBStructure.Progress,progress);
    ...
    public Cursor ReadIDEvents_2(String date,String event, String time,SQLiteDatabase database){
        String [] Projections = {DBStructure.ID,DBStructure.Progress};
        String Selection = DBStructure.DATE +"=? and "+DBStructure.EVENT+"=? and "+DBStructure.TIME+"=?";
        String [] SelectionArgs = {date,event,time};
        return database.query(DBStructure.EVENT_TABLE_NAME,Projections,Selection,SelectionArgs, null, null,null);
    ...
    public void updateEvent_2(String date,String event, String time,String progress,SQLiteDatabase database){
        ContentValues contentValues = new ContentValues();
        contentValues.put(DBStructure.Progress,progress);
        String Selection = DBStructure.DATE +"=? and "+DBStructure.EVENT+"=? and "+DBStructure.TIME+"=?";
        String [] SelectionArgs = {date,event,time};
